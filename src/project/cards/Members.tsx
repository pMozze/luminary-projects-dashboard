...
const Members: FC<Members> = ({ projectManager, teamAvatars }) => {
  return (
    <div className="flex flex-col items-center">
      ...
      <img className="mt-1 w-14 h-14 rounded-full" src="https://placehold.co/56x56/EEE/31343C" alt="" />
      <div className="mt-2 text-tiny text-[#000000]">Name Surname</div>
      <div className="mt-1 text-tiny text-[#828B95]">Manager</div>
      ...
      <div className="mt-2 flex items-center gap-1">
        <div className="p-1 border-1 border-[#A2A7AE] rounded-full flex items-center gap-0.5">
          ...
          <img className="w-4 h-4 rounded-full" src="https://placehold.co/16x16/EEE/31343C" alt="" />
          <img className="w-4 h-4 rounded-full" src="https://placehold.co/16x16/EEE/31343C" alt="" />
          <div className="text-tiny text-[#A2A7AE]">+2</div>
        </div>
